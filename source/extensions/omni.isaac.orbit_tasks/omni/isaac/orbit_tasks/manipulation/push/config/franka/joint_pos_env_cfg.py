...
from omni.isaac.orbit_tasks.manipulation.push import mdp
from omni.isaac.orbit_tasks.manipulation.push.push_env_cfg import PushEnvCfg
...
@configclass
class FrankaTBlockPushEnvCfg(PushEnvCfg):
...
@configclass
class FrankaTBlockPushEnvCfg_PLAY(FrankaTBlockPushEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
